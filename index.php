                                    ...
                                    <div class="form-container">
                                        <form id="hero-form-rf">
											...
											<div class="form-step step-2">  
												<div class="step-title">
													<p>Step 2 - Employer Information<span></span></p>
                                                    <p class="step-req">
                                                        Please provide direct contact information regarding the role you are recruiting for.
                                                    </p>
												</div>
												<div class="form-fields"> 
                                                    <fieldset>
                                                    ...
                                                    <fieldset>
                                                        <label>E-mail:</label>
                                                        <input type="email" name="email"  class="required d8val_email "  id="email" placeholder="Your E-mail"/>
