                            ...
                            <div class='col-12 col-md-6'>
                                <div class="hero-form" data-aos="fade-up" data-aos-duration="800">
                                    <div class="form-title-content">
                                        <p>Complete our two step form and <br /> <span>we will find your next top hire</span>.   </p>
                                    </div>
                                    <div class="form-container">
                                        <form id="hero-form-alt">
                                            <div class="form-step step-1 step-current ">  
                                                <div class="step-title">
                                                    <p>Step 1 - Employer Information<span></span></p>
                                                    <p class="step-req">
                                                ...
                                                <div class="form-fields"> 
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <input type="tel" name="telephone" id="telephone" required placeholder="Your Telephone Number"/>
                                                    </fieldset> 
													<fieldset>
											...
											<div class="form-button-container next-container">
												<button class="form-button form-next">Next</button>
											</div> 
