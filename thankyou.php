...
<html lang="en-GB" class="no-js">
    <head>
       ...
       <?php /*
        ...
        <script>
            gtag('event', 'conversion', {'send_to': 'AW-595277874/_ywYCJLcx90BELLw7JsC'});
        </script>
                    ...
                    <div class='container'>
                        <div class='row'>
                            <div class='col-12 col-md-4'>
                                <div class="prep-form-info">
                                    <div class="enquiry-prep-text">
                                        ...
                                        <p>Complete this handy enquiry prep form, so we can get a few details ready for our initial meeting.</p>
                                    </div>
                                    <div class="alt-call">
                                        <h3>Get In Touch</h3>
                            ...
                            <div class='col-12 col-md-8'>
                                ...
                                <p class="form-explain">*For guidelines on how to complete the preparation form, please see the <a href="#">preparation form notes</a> below.</p>
                            </div> 
                        </div>  
                    </div>
                </section> 
                            ...
                            <div class='col-12 col-md-7'>
                                <div class="half-content prep-content">
                                    <div class="inner-prep-content">
                                        ...
                                        <p>
                                            We'll be in touch shortly to discuss your enquiry, so it's best to prepare a few things in advance. For us to deliver our <b class="gold"><i>"100% satisfaction guarantee"</i></b> service we'll need a few key pieces of information about your business and the role itself. 
                                            <br /> <br />
                                            If you've got time. please see below for our typical fact finding questions that get us started. </p>
                                        <ul>
                                        ...
                                        <p>If you've got time, why not complete our <b><i>meeting preparation form</i></b> so we can come prepared also.</p>
                                        <a class="cta cta-primary cta-prep-form">Preperation Form</a>
                                    </div>
                                </div>
                            </div> 
