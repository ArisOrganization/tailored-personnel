                ...
                <section class='hero'>
                    <div class='container'>
                        <div class='row'>
                            <div class='col-12 col-md-6'>
                                <div class="hero-content">
                                    <div class="inner-hero-content">
                                        <h1><span>Market Leading Talent Acquisition</span> ONLY 8% Commission </h1>
                                        <p class="tagline">
                            ...
                            <div class='col-12 col-md-6'>
                                <div class="hero-form" data-aos="fade-up" data-aos-duration="800">
                                    <div class="form-title-content">
                                        <p>Complete the quick, simple form and <br /> <span>we will find your next top hire</span>.   </p>
                                    </div>
                                        ...
                                        <form id="hero-form">
                                            <div class="form-step step-1 step-current ">  
                                                <div class="step-title">
                                                    ...
                                                    <p>Your Information<span></span></p>
                                                    <p class="step-req">
                                                        Please provide direct contact information for an individual, not your organisation, so we can speak to you about your specific requirements.
                                                    </p>
                                                </div>
                                            ...
                                            <!-- 
                                                <div class="form-step step-2">  
                                                    <div class="step-title">
                                                        <p>Step 2 - Role Information</p>
                                                        <p class="step-req">
                                                            Our Team will reply immediately with potential candidate details for this role.   
                                                        </p>
                                                    </div>
                                                    <div class="form-fields">
                                                        <fieldset>
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <input type="text" name="position" id="position" placeholder="Position / Role"/>
                                                        </fieldset> 
                                                        <fieldset>
                                                ...
                                                <div class="form-button-container">
                                                    <button class="form-button form-submit">Submit</button>
                                                </div> 
                                            -->
                                            <div class="form-button-container">
                                                <button class="form-button form-next">Find Top Talent Now </button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div class='row'>
                            ...
                            <div class='col-12 col-md-6'>
                                <div class="chose-content">
                                    <div class="inner-chose-content"> 
                                        ...
                                        <p>
                                            The industry standard is 15%. Tailored personnel operate on 8% commission, offering our one of a kind, totally bespoke talent acquisition service that guarantees we find you the right person for the job.
                                        </p>
                                    </div>
                                </div> 
                            </div>  
                            <div class='col-12 col-md-6'>
                                <div class="chose-content">
                                    ...
                                    <p>                                                 
                                        We aim to deliver candidates within 14 days. Once approved we push through the application to completion, all while ensuring highest quality service to you and your new employee.
                                    </p>
                                    </div>
                                </div> 
                            </div> 
                            <div class='col-12 col-md-6'>
                                <div class="chose-content">
                                    ...
                                    <p>Your specialist recruiter is assigned to your business as your point of contact from start to finish, always available to discuss new developments. </p>
                                    </div>
                                </div> 
                            </div> 
                            <div class='col-12 col-md-6'>
                                <div class="chose-content">
                                    ...
                                    <p>Our specific process that includes, pre screening and a 5 stage recruitment process ensures that we fulfill your requirements to your exact specification, making sure you only acquire and retain the talent you need for business success.</p>
                                    </div>
                                </div> 
                            </div> 
                        </div>  
                        ...
                        <div class='row'>
                            <div class='col-12 col-md-7'>
                                <div class="roles-content">
                                    ...
                                    <p>
                                        Whether you are looking to hire a senior executive through to a junior role, we put our team to work to help you find the right person for the job. We cover all business sectors providing you bespoke staff for your companies needs.            
                                        <br />  
                                        <br />  
                            ...
                            <div class='col-12 col-md-5'>
                                <div class="image-container">
                                    <div  data-aos="fade-up"  data-delay="0" style="background-image: url('assets/img/roles/manager.jpg');"></div>
                                    <div   data-aos="fade-up"  data-delay="0" style="background-image: url('assets/img/roles/artist.jpg');"></div>
                                    <div   data-aos="fade-up"  data-delay="0" style="background-image: url('assets/img/roles/engineer.jpg');"></div>
                            ...
                            <div class='col-12'>
                                ...
                                <div class="faq-content-container">
                                    ...
                                    <div class="faq-item">
                                        ...
                                        <p class="faq-a">
                                            Our recruitment fee structure depends on the type of hire you are looking to make. These include permanent hiring fees and a range of other recruitment services. We also offer a flexible recruitment pricing structure depending on whether you are looking to make a one-off hire or multiple hires. If you would like to find out more about our recruitment agency fees, please get in touch today on .                                        
                                        </p>
                                    </div>
                                    <div class="faq-item">
                                        <p class="faq-q">
